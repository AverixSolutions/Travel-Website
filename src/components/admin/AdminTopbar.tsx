      ...
      <div className="container flex items-center justify-between py-3">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="relative w-20 md:w-24 h-14 rounded-xl overflow-hidden bg-brand/10 flex items-center justify-center">
              <Image
                src="/mysha-logo.png"
                alt="Mysha Travels"
                width={80}
            ...
            <div>
              <h2 className="text-base font-black text-foreground flex items-center gap-1 md:gap-2">
